...
public class DetailFragment extends Fragment implements View.OnClickListener{
    ...
    String[] youtube_ids;
    int trailer_count,review_count;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sort = sharedPreferences.getString("sort_type", "popular");
    }
    ...
    public class FetchMovieDetails extends AsyncTask<Void, Void, Void> {
                ...
                if (c.moveToFirst()) {
                    do {
                        if (c.getString(c.getColumnIndex(FavoritesProvider._ID)).equals(id.toString())) {
                            ...
                            favPoster = c.getBlob(c.getColumnIndex(FavoritesProvider.POSTER));
                        }
                    } while (c.moveToNext());
                }
            }
        ...
        protected void onPostExecute(Void result) {
            ...
            if(sort.equals("favorites")) {
                ...
                Bitmap bmp = BitmapFactory.decodeByteArray(favPoster, 0, favPoster.length);
